...
def add_service(data,statement_list):
    ...
    return "devre_mulk başarıyla oluşturuldu",200    
...
def delete_service(data,statement):
    ...
    return "devre_mulk başarıyla silindi",200   
...
def update_service(data,statement):
    ...
    return "devre_mulk başarıyla güncellendi",200   
